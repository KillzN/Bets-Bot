...
/* Creditos a Otosaka (https://wa.me/393770978499) */
...
mobile: MethodMobile, 
browser: opcion == '1' ? ['@betsxx.lz', 'XVIDEOS', '2.0.0'] : methodCodeQR ? ['@betsxx.lz', 'XVIDEOS', '2.0.0'] : ['Ubuntu', 'Chrome', '20.0.04'],
auth: {
creds: state.creds,
