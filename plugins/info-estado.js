...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} Betsa
  ${tradutor.texto1[2]} +393770978499
  ...
  const Message = {
    document: { url: `https://www.instagram.com/betsxx.lz/` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://www.instagram.com/betsxx.lz/",
        mediaType: 2,
        previewType: "pdf",
        title: "Betsa",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://www.instagram.com/betsxx.lz/",
      },
    },
    caption: info,
    footer: wm,
